...
import focus from "../assets/target.png"
import brain from "../assets/mindset.png"
import vison from "../assets/succession-planning.png"
    ...
    <section id="about" className="relative py-32 overflow-hidden bg-[#faf9f6]">
      ...
      <div className="relative max-w-[1100px] mx-auto px-6">
        ...
        <motion.div
          ...
          className="bg-white/40 backdrop-blur-2xl border border-[rgba(200,180,150,0.3)] rounded-[3rem] p-10 md:p-16 shadow-[0_20px_50px_rgba(120,100,70,0.1)] mb-24"
        >
          <div className="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
            ...
            >
              ...
              <img
                src={profilbild}
                alt="Emilia Eriksson"
                className="relative w-56 h-56 object-cover border-4 border-white shadow-2xl transition-all duration-500 hover:scale-105 animate-blob"
              />
            </motion.div>
          </div>
        </motion.div>

        {/* --- GRID MED INTERAKTIVA KORT --- */}
        <div className="grid gap-8 md:grid-cols-3">
          {cards.map((item, index) => (
            ...
            >
              ...
              <div className="relative h-full bg-white/60 backdrop-blur-md border border-white/50 rounded-3xl p-8 shadow-sm group-hover:shadow-2xl transition-all duration-500 overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="mb-6 transform group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300 inline-block">
                    {/* HÄR VISAS DIN BILD ISTÄLLET FÖR ICON */}
                    <img 
                      src={item.image} 
                      alt={item.title} 
